...
class Tracker:
    ...
    def encode_items(self, tanks, ifv, apc) -> np.array:
        ...
        array = np.array(
            [[tanks_value, ifv_value, apc_value, atgm_value, cluster_shells_value, unitar_shells_value, fpv_value]])
    ...
    def return_data(self, amount, actions, tactic_prediction, command, priority):
        ...
        data = {
            ...
            "actions": {"moving_forward": moving_forward, "from_left_flank": from_left_flank,
                        "from_right_flank": from_right_flank, "moving_back": moving_back},
    ...
    def _run(self):
        ...
        try:
            while True:
                ...
                self.last = vis
                # возврат логов
                self.logs = self.return_data(amount, actions, tactic_prediction, command, priority)
